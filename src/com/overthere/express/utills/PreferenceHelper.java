...
public class PreferenceHelper {
	...
	public final String TRAVEL_DISTANCE = "distance";
	...
	public  final String OVERHERE_REQUEST_ID = "overhere_request_id";
	private final String REQUEST_TIME = "request_time";
    private final String START_TIME = "start_time";
	private final String PICKUP_AREA = "pickup_area";
	private final String DROPOFF_AREA = "dropoff_area";
	private final String PICKUP_ADDRESS = "pickup_address";
	private final String DROPOFF_ADDRESS = "dropoff_address";
	private final String REQUEST_SOURCE = "request_source";
	private final String PICKUP_TYPE = "pickup_type";
    ...
    //general
	public void putBoolean (String PARAM_NAME, boolean BValue) {
		Editor edit = app_prefs.edit();
		edit.putBoolean(PARAM_NAME, BValue);
		edit.commit();
	}
	public Boolean getBoolean(String PARAM_NAME) {
		return app_prefs.getBoolean(PARAM_NAME, false);
	}
	//general
	public void putString (String PARAM_NAME, String SValue) {
		Editor edit = app_prefs.edit();
		edit.putString(PARAM_NAME, SValue);
		edit.commit();
	}
	public String getString(String PARAM_NAME) {
		return app_prefs.getString(PARAM_NAME, "");
	}

	public void putInt(String PARAM_NAME, Integer SValue) {
		Editor edit = app_prefs.edit();
		edit.putInt(PARAM_NAME, SValue);
		edit.commit();
	}
	public Integer getInt(String PARAM_NAME) {
		return app_prefs.getInt(PARAM_NAME, 0);
	}

	public void putLong(String PARAM_NAME, long SValue) {
		Editor edit = app_prefs.edit();
		edit.putLong(PARAM_NAME, SValue);
		edit.commit();
	}
	public long getLong(String PARAM_NAME) {
		return app_prefs.getLong(PARAM_NAME, 0);
	}

	public void putServiceType(String type) {
		Editor edit = app_prefs.edit();
		edit.putString(SERVICE_TYPE, type);
		edit.commit();
	...
	public String getPickupAddress() {
		return app_prefs.getString(PICKUP_ADDRESS, null);
	}

	public void putPickupAddress(String pickupAddress) {
		Editor edit = app_prefs.edit();
		edit.putString(PICKUP_ADDRESS, pickupAddress);
		edit.commit();
	}
	public String getDropoffAddress() {
		return app_prefs.getString(DROPOFF_ADDRESS, null);
	}

	public void putDropoffAddress(String dropoffAddress) {
		Editor edit = app_prefs.edit();
		edit.putString(DROPOFF_ADDRESS, dropoffAddress);
		edit.commit();
	}
	public String getPickupArea() {
		return app_prefs.getString(PICKUP_AREA, null);
	}

	public void putPickupArea(String pickupArea) {
		Editor edit = app_prefs.edit();
		edit.putString(PICKUP_AREA, pickupArea);
		edit.commit();
	}
	public String getDropoffArea() {
		return app_prefs.getString(DROPOFF_AREA, null);
	}

	public void putDropoffArea(String dropoffArea) {
		Editor edit = app_prefs.edit();
		edit.putString(DROPOFF_AREA, dropoffArea);
		edit.commit();
	}
	public String getRequestSource() {
		return app_prefs.getString(REQUEST_SOURCE, null);
	}

	public void putRequestSource(String requestSource) {
		Editor edit = app_prefs.edit();
		edit.putString(REQUEST_SOURCE, requestSource);
		edit.commit();
	}
	public String getPickupType() {
		return app_prefs.getString(PICKUP_TYPE, null);
	}

	public void putPickupType(String pickupType) {
		Editor edit = app_prefs.edit();
		edit.putString(PICKUP_TYPE, pickupType);
		edit.commit();
	}
	public String getOverHereRequestID() {
		return app_prefs.getString(OVERHERE_REQUEST_ID, null);
	}

	public void putOverHereRequestID(String overehereRequestID) {
		Editor edit = app_prefs.edit();
		edit.putString(OVERHERE_REQUEST_ID, overehereRequestID);
		edit.commit();
	}
	...
	public void putStartTime(long time) {
		Editor edit = app_prefs.edit();
		edit.putLong(START_TIME, time);
		edit.commit();
	}

	public long getStartTime() {
		return app_prefs.getLong(START_TIME, AndyConstants.NO_TIME);
	}
