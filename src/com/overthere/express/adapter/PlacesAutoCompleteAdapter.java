...
public class PlacesAutoCompleteAdapter extends ArrayAdapter<String> implements
	...
	public ArrayList<String> autocomplete(String input) {
		...
		try {
			StringBuilder sb = new StringBuilder(AndyConstants.PLACES_API_BASE
					+ AndyConstants.TYPE_AUTOCOMPLETE + AndyConstants.OUT_JSON);
			sb.append("?sensor=false&key=" + AndyConstants.PLACES_AUTOCOMPLETE_API_KEY);
